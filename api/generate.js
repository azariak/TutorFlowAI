...
export default async function handler(req, res) {
  ...
  try {
    ...
    const instructions = [
      ...
      "When you see a whiteboard image, do not comment on the board, but use it to see the user's work thus far, to help you tutor better using their example. Concisely, describe what you see in the whiteboard. Do not add bot: to your response"
    ].join(' ');
